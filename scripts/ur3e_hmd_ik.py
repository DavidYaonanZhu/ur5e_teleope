...
init_pos90_15cmtool=[1.57,-1.9722,1.9722,-1.57,-1.57,-1.57] 
init_ur3e_hmd=[-1.3521,-1.8001,-1.6934,0.0,1.4885,4.8104] 
init_pos4=init_ur3e_hmd
...
class PR2Teleop(object):
    ...
    def __init__(self):
        ...
        self.ik_right = IK("base_link",
                           "ee_link",(1.0/control_rate)*0.4,1e-3,"Distance",urdf)
        print(1.0/control_rate)
        lower_bound, upper_bound = self.ik_right.get_joint_limits()
        print(lower_bound, upper_bound)
        self.ik_right.set_joint_limits(lower_bound, upper_bound)
        ...
        self.right_pose = rospy.Subscriber('ur3e_hmd/robot_tar_pose',
                                           PoseStamped,
...
if __name__ == '__main__':
    rospy.init_node('ur3e_hmd_ik_py')
    nv = PR2Teleop()
    nv.init_pose()
